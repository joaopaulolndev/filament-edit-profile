...
return [
    ...
    'browser_sessions_list_unavailable' => 'A lista das suas sessões ativas não está disponível. Ainda assim, pode terminar as suas outras sessões do navegador abaixo.',
];
