...
return [
    ...
    'two_factor' => [
        ...
        'description'                  => 'Adjon extra biztonságot fiókjához kétfaktoros hitelesítéssel',
        'password_incorrect'           => 'A megadott :attribute helytelen.',
        'notification_title_approved'  => 'A kétfaktoros hitelesítés jóváhagyva!',
        'code'                         => 'Kód',
        'recovery_code'                => 'Helyreállítási kód',
        'use_recovery_code'            => 'Helyreállítási kód használata',
        'you_can_logout'               => 'vagy kijelentkezhet',
        'button_confirm'               => 'Megerősítés',
        'code_incorrect'               => 'A kód helytelen!',
        'enabled' => [
            'heading'                    => 'Kétfaktoros hitelesítés bekapcsolása',
            'description'                => 'A kétfaktoros hitelesítés egy extra biztonsági réteget ad fiókjához. Ha engedélyezve van, a hitelesítés során egy biztonságos, véletlenszerű tokent kell megadnia.',
            'sub_description'            => 'A kétfaktoros hitelesítés bekapcsolásához kérjük, erősítse meg jelszavát az alábbiakban.',
            'label'                      => 'Kétfaktoros hitelesítés bekapcsolása',
            'modal_heading'              => 'Kétfaktoros hitelesítés bekapcsolása',
            'modal_description'          => 'Biztosan engedélyezni kívánja a kétfaktoros hitelesítést?',
            'modal_submit_action_label'  => 'Engedélyezés',
            'notification_title'         => 'A kétfaktoros hitelesítés engedélyezve lett',
        ],
        'disabled' => [
            'heading'                       => 'A kétfaktoros hitelesítést bekapcsolta.',
            'description'                   => 'Amikor a kétfaktoros hitelesítés be van kapcsolva, egy biztonságos, véletlenszerű tokent kell megadnia a hitelesítés során.',
            'sub_description'               => 'A kétfaktoros hitelesítés befejezéséhez olvassa be a következő QR-kódot telefonos hitelesítő alkalmazásával, vagy írja be a beállító kulcsot, és adja meg a generált OTP-kódot.',
            'setup_key'                     => 'Beállító kulcs:',
            'recovery_code_description'     => 'Tárolja ezeket a helyreállítási kódokat egy biztonságos jelszókezelőben. Ezek a kódok használhatók fiókjának visszaszerzésére, ha elveszíti a kétfaktoros hitelesítési eszközét.',
            'label'                         => 'Kétfaktoros hitelesítés kikapcsolása',
            'modal_heading'                 => 'Kétfaktoros hitelesítés kikapcsolása',
            'modal_description'             => 'Biztosan ki akarja kapcsolni a kétfaktoros hitelesítést?',
            'modal_submit_action_label'     => 'Kikapcsolás',
            'notification_title'            => 'A kétfaktoros hitelesítés kikapcsolva lett',
        ],
    ],
];
