...
return [
    ...
    'two_factor' => [
        ...
        'password_incorrect'           => 'Le :attribute fourni est incorrect.',
        'notification_title_approved'  => 'L\'authentification à deux facteurs a été approuvée !',
        'code'                         => 'Code',
        'recovery_code'                => 'Code de récupération',
        'use_recovery_code'            => 'Utiliser le code de récupération',
        'you_can_logout'               => 'ou vous pouvez vous déconnecter',
        'button_confirm'               => 'Confirmer',
        'code_incorrect'               => 'Le code est incorrect !',
        'enabled' => [
            'heading'                    => 'Activer l\'authentification à deux facteurs',
            'description'                => 'L\'authentification à deux facteurs ajoute une couche de sécurité supplémentaire à votre compte. Une fois activée, un jeton sécurisé aléatoire vous sera demandé lors de l\'authentification.',
            'sub_description'            => 'Pour activer l\'authentification à deux facteurs, veuillez confirmer votre mot de passe ci-dessous.',
            'label'                      => 'Activer l\'authentification à deux facteurs',
            'modal_heading'              => 'Activer l\'authentification à deux facteurs',
            'modal_description'          => 'Êtes-vous sûr de vouloir activer l\'authentification à deux facteurs ?',
            'modal_submit_action_label'  => 'Activer',
            'notification_title'         => 'L\'authentification à deux facteurs a été activée',
        ],
        'disabled' => [
            'heading'                       => 'Vous avez activé l\'authentification à deux facteurs.',
            'description'                   => 'Lorsque l\'authentification à deux facteurs est activée, un jeton sécurisé aléatoire vous sera demandé lors de l\'authentification.',
            'sub_description'               => 'Pour terminer l\'activation de l\'authentification à deux facteurs, scannez le code QR suivant à l\'aide de l\'application d\'authentification de votre téléphone ou entrez la clé de configuration et fournissez le code OTP généré.',
            'setup_key'                     => 'Clé de configuration :',
            'recovery_code_description'     => 'Stockez ces codes de récupération dans un gestionnaire de mots de passe sécurisé. Ils peuvent être utilisés pour récupérer l\'accès à votre compte si votre appareil d\'authentification à deux facteurs est perdu.',
            'label'                         => 'Désactiver l\'authentification à deux facteurs',
            'modal_heading'                 => 'Désactiver l\'authentification à deux facteurs',
            'modal_description'             => 'Êtes-vous sûr de vouloir désactiver l\'authentification à deux facteurs ?',
            'modal_submit_action_label'     => 'Désactiver',
            'notification_title'            => 'L\'authentification à deux facteurs a été désactivée',
        ],
    ],
];
