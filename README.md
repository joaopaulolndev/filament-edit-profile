...
![Screenshot of avatar Feature](https://raw.githubusercontent.com/noopstudios/filament-edit-profile/main/art/profile-avatar.png)
Show the user avatar form using `shouldShowAvatarForm()`. This package now uses [Spatie Media Library](https://spatie.be/docs/laravel-medialibrary) for avatar management, providing more robust image handling.
